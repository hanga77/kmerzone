...
export const initialCategories: Category[] = [
    ...
    { id: 'cat-services', name: 'categories.services', imageUrl: 'https://images.unsplash.com/photo-1516321497487-e288fb19713f?q=80&w=2070&auto=format&fit=crop' },
    ...
    { id: 'sub-serv-education', parentId: 'cat-services', name: 'categories.serv_education', imageUrl: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=2070&auto=format&fit=crop' },
    { id: 'sub-serv-bricoleur', parentId: 'cat-services', name: 'categories.serv_diy', imageUrl: 'https://images.unsplash.com/photo-1556912173-3535a353684a?q=80&w=2070&auto=format&fit=crop' },
    { id: 'sub-serv-beaute', parentId: 'cat-services', name: 'categories.serv_beauty_health', imageUrl: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?q=80&w=2070&auto=format&fit=crop' },
    { id: 'sub-serv-transport', parentId: 'cat-services', name: 'categories.serv_transport', imageUrl: 'https://images.unsplash.com/photo-1570125909232-eb263c186902?q=80&w=2070&auto=format&fit=crop' },
    { id: 'sub-serv-reparation', parentId: 'cat-services', name: 'categories.serv_repair_construction', imageUrl: 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?q=80&w=2070&auto=format&fit=crop' },
    { id: 'sub-serv-informatique', parentId: 'cat-services', name: 'categories.serv_it', imageUrl: 'https://images.unsplash.com/photo-1517694712202-1428bc3cd4a5?q=80&w=2070&auto=format&fit=crop' },
    { id: 'sub-serv-entreprises', parentId: 'cat-services', name: 'categories.serv_business', imageUrl: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=2071&auto=format&fit=crop' },
    { id: 'sub-serv-nettoyage', parentId: 'cat-services', name: 'categories.serv_cleaning', imageUrl: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=2070&auto=format&fit=crop' },
    { id: 'sub-serv-auto', parentId: 'cat-services', name: 'categories.serv_auto', imageUrl: 'https://images.unsplash.com/photo-1494976388531-d1058494cdd8?q=80&w=2070&auto=format&fit=crop' },
    { id: 'sub-serv-equipement', parentId: 'cat-services', name: 'categories.serv_equipment_repair', imageUrl: 'https://images.unsplash.com/photo-1553049137-37e9b0a1d6f1?q=80&w=2070&auto=format&fit=crop' },
];
...
export const initialProducts: Product[] = [
    ...
    { id: 'serv-1', name: "Assistance Informatique à Domicile", price: 20000, imageUrls: ['https://images.unsplash.com/photo-1558346489-19413928158b?q=80&w=2070&auto=format&fit=crop'], vendor: 'KMER Enterprise', description: "Un expert se déplace chez vous pour résoudre tous vos problèmes informatiques : virus, lenteurs, installation de logiciels, configuration réseau et bien plus. Service rapide et efficace.", reviews: [], stock: 1, categoryId: 'sub-serv-informatique', status: 'published', type: 'service', duration: "par heure", locationType: 'on-site', serviceArea: 'Douala & Yaoundé', availability: "Lundi - Samedi, 9h - 18h"},
    { id: 'serv-2', name: "Cours de soutien en Mathématiques", price: 15000, imageUrls: ['https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2070&auto=format&fit=crop'], vendor: 'KMER Enterprise', description: "Professeur expérimenté propose des cours de soutien en mathématiques pour les élèves de niveau lycée. Préparation aux examens, aide aux devoirs et consolidation des acquis. Sessions en ligne ou à domicile.", reviews: [], stock: 1, categoryId: 'sub-serv-education', status: 'published', type: 'service', duration: "par séance de 2h", locationType: 'flexible', serviceArea: "National (en ligne) / Douala (à domicile)", availability: "Sur rendez-vous"},
    { id: 'serv-3', name: "Maquillage professionnel pour événements", price: 30000, imageUrls: ['https://images.unsplash.com/photo-1615904523295-a2d04a6316f2?q=80&w=1964&auto=format&fit=crop'], vendor: 'Kmer Fashion', description: "Sublimez votre beauté pour vos occasions spéciales (mariages, soirées, galas). Maquilleuse professionnelle utilisant des produits de haute qualité pour un résultat impeccable et longue tenue.", reviews: [], stock: 1, categoryId: 'sub-serv-beaute', status: 'published', type: 'service', duration: "par personne", locationType: 'on-site', serviceArea: 'Douala', availability: "Sur rendez-vous"},
    { id: 'serv-4', name: "Nettoyage résidentiel complet", price: 25000, imageUrls: ['https://images.unsplash.com/photo-1603791440384-56cd371ee9a7?q=80&w=1974&auto=format&fit=crop'], vendor: 'KMER Enterprise', description: "Service de nettoyage complet pour votre appartement ou maison. Dépoussiérage, lavage des sols, nettoyage des vitres, et désinfection des sanitaires et de la cuisine. Retrouvez un intérieur impeccable.", reviews: [], stock: 1, categoryId: 'sub-serv-nettoyage', status: 'published', type: 'service', duration: "par intervention (3h max)", locationType: 'on-site', serviceArea: 'Douala uniquement', availability: "7j/7, 8h - 16h"},
];
