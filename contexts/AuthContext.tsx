...
const initialUsers: User[] = [
    ...
    { id: 'agent-1', name: 'Paul Atanga', email: 'agent1@example.com', password: 'password', role: 'delivery_agent', loyalty: { status: 'standard', orderCount: 0, totalSpent: 0, premiumStatusMethod: null }, availabilityStatus: 'available', addresses: [], followedStores: [], notificationPreferences: defaultNotificationPrefs },
    { id: 'agent-2', name: 'Brenda Biya', email: 'agent2@example.com', password: 'password', role: 'delivery_agent', loyalty: { status: 'standard', orderCount: 0, totalSpent: 0, premiumStatusMethod: null }, availabilityStatus: 'available', addresses: [], followedStores: [], notificationPreferences: defaultNotificationPrefs },
    { id: 'depot-agent-1', name: 'Agent Dépôt Akwa', email: 'depot@example.com', password: 'password', role: 'depot_agent', depotId: 'pp1', loyalty: { status: 'standard', orderCount: 0, totalSpent: 0, premiumStatusMethod: null }, addresses: [], followedStores: [], notificationPreferences: defaultNotificationPrefs },
    { id: 'depot-manager-1', name: 'Chef de Dépôt Akwa', email: 'depot.manager@example.com', password: 'password', role: 'depot_manager', depotId: 'pp1', loyalty: { status: 'standard', orderCount: 0, totalSpent: 0, premiumStatusMethod: null }, addresses: [], followedStores: [], notificationPreferences: defaultNotificationPrefs },
];
