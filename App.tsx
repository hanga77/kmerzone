...
const initialStores: Store[] = [
    { id: '1', name: 'Mama Africa', logoUrl: 'https://picsum.photos/seed/mama/200/100', category: 'Restaurant & Alimentation', warnings: [], status: 'active', location: 'Yaoundé', neighborhood: 'Bastos', sellerFirstName: 'Mama', sellerLastName: 'Africa', sellerPhone: '699887766', physicalAddress: '123 Rue de la Joie', documents: [] },
    { id: '2', name: 'Kmer Fashion', logoUrl: 'https://picsum.photos/seed/kmerfashion/200/100', category: 'Mode', warnings: [{id: 'warn1', date: '2023-10-01T10:00:00Z', reason: 'Non-respect des délais de livraison.'}], status: 'active', location: 'Douala', neighborhood: 'Akwa', sellerFirstName: 'Adèle', sellerLastName: 'Ngo', sellerPhone: '677665544', physicalAddress: '45 Avenue de la Mode', documents: [] },
    ...
    { id: '4', name: 'Douala Soaps', logoUrl: 'https://picsum.photos/seed/soap-store/200/100', category: 'Artisanat', warnings: [], status: 'active', location: 'Douala', neighborhood: 'Marché Central', sellerFirstName: 'Fatima', sellerLastName: 'Gaye', sellerPhone: '688776655', physicalAddress: 'Boutique 15', documents: [] },
];
