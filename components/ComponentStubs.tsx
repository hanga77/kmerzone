...
interface InfoPageProps {
  ...
  // FIX: Added siteData and authData to match the props passed by PageRouter
  siteData: any;
  authData: any;
}
...
export const InfoPage: React.FC<InfoPageProps> = ({ title, content, slug, onBack, siteData, authData, onProductClick, onCategoryClick, onVendorClick }) => {
    
    // FIX: Destructure needed data from the siteData prop
