...
interface SellerSubscriptionPanelProps {
  store: Store;
...
const SellerSubscriptionPanel: React.FC<SellerSubscriptionPanelProps> = ({ store, siteSettings, onUpgrade }) => {
    ...
    const plans = [
        {
            ...
            onSelect: () => {}, // Cannot select standard
            isFeatured: false,
        },
        {
...
export default SellerSubscriptionPanel;
