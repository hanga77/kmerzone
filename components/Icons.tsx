...
export const StarIcon: React.FC<IconProps & { filled?: boolean, title?: string } & React.SVGProps<SVGSVGElement>> = ({ className, filled = true, title, ...rest }) => (
...
export const StarPlatinumIcon: React.FC<IconProps & { title?: string } & React.SVGProps<SVGSVGElement>> = ({ className, title, ...rest }) => (
...
export const BecomeSellerIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M7.17 6c-2.2 0-3.99 1.79-3.99 4v4c0 2.21 1.79 4 3.99 4h.83v-12h-.83zm2.83 12h2V6h-2v12zm4-12v12h2V6h-2zm4 3v9h2V9h-2z"/>
  </svg>
);
...
{/* FIX: Added title prop for accessibility, which was causing a type error in consuming components. */}
export const CheckCircleIcon: React.FC<IconProps & { title?: string }> = ({ title, ...props }) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        {title && <title>{title}</title>}
...
{/* FIX: Added title prop for accessibility, which was causing a type error in consuming components. */}
export const ShieldCheckIcon: React.FC<IconProps & { title?: string }> = ({ title, ...props }) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    {title && <title>{title}</title>}
...
export const QrCodeIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5v15h15V4.5h-15Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 9h.75v.75h-.75V9Zm0 3.75h.75v.75h-.75v-.75Zm0 3.75h.75v.75h-.75v-.75Zm3.75-7.5h.75v.75h-.75V9Zm0 7.5h.75v.75h-.75v-.75Zm3.75-7.5h.75v.75h-.75V9Zm0 3.75h.75v.75h-.75v-.75Zm0 3.75h.75v.75h-.75v-.75Z" />
  </svg>
);

export const ArrowPathIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.696L7.985 5.986m11.667 0l-3.181 3.183a8.25 8.25 0 01-11.667 0l-3.181-3.183" />
  </svg>
);
...
export const PaperclipIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3.375 3.375 0 0119.5 7.372l-8.625 8.625a1.875 1.875 0 01-2.652-2.652l6.815-6.815" />
  </svg>
);
...
export const BellSnoozeIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const ShieldExclamationIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m0-10.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.75c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.75h-.152c-3.196 0-6.1-1.248-8.25-3.286z" />
  </svg>
);
