...
const ComparisonPage: React.FC<ComparisonPageProps> = ({ onBack, allCategories }) => {
  ...
  const getCategoryName = (categoryId: string) => {
    return allCategories.find(c => c.id === categoryId)?.name || 'Inconnue';
  };
  ...
  const features = [
    ...
    { name: 'Catégorie', render: (p: Product) => getCategoryName(p.categoryId) },
  ];
