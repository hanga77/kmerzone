      ...
      <div className="relative">
        ...
        <div className="absolute bottom-2 right-2">
            <button 
              ...
              className={`flex items-center justify-center h-12 w-12 text-gray-900 rounded-full shadow-md transform transition-all duration-300 hover:scale-110 bg-kmer-yellow disabled:bg-gray-400 disabled:cursor-not-allowed`}
